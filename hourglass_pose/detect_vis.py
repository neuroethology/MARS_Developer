...
def detect(tfrecords, checkpoint_path, save_dir, max_iterations, iterations_per_record, cfg):
  ...
  with graph.as_default():
    ...
    fetches = [predicted_heatmaps[-1], batched_bboxes, batched_scores, batched_image_ids, batched_labels, batched_image_height_widths, batched_crop_bboxes, batched_images]
