...
def backgroundFalseNegErrors( coco_analyze, imgs_info, saveDir ):
    ...
    if max_width>1024:
        ar_pic_2 = np.zeros((32, 32))
        ar_bins = range(10) + range(10, 100, 10) + range(100, 1000, 100) + range(1000, 1400, 100) + [1400]
        ar_pic_3 = np.zeros((11, 11))
        ar_bins_3 = [np.power(2,x) for x in xrange(12)]
    else:
    ...
    for i,b in enumerate(fn_gts):
        ...
        if b_width < 1280 and b_height < 1280:
