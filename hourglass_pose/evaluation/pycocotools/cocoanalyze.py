...
class Params:
    ...
    def setKpParams(self):
        self.imgIds = []
        self.catIds = []
        self.kpts_name     = [u'nose',u'right_ear', u'left_ear',u'neck',u'right_side', u'left_side',u'tail']
        self.inv_kpts_name = [u'neck',u'left_ear', u'right_ear', u'nose', u'left_side', u'right_side',u'tail']
        self.num_kpts = len(self.kpts_name)
        self.inv_idx  = [self.inv_kpts_name.index(self.kpts_name[i]) for i in xrange(self.num_kpts)]
        self.sigmas= np.array([0.02349794, 0.02573029, 0.02574004, 0.02459145, 0.03146337, 0.03146769, 0.02510474])#top
        #self.sigmas= np.array([0.03465136, 0.0344434 , 0.03461611, 0.0362902 , 0.04186067, 0.04204246, 0.03432178, 0.04125073,0.04113029, 0.04016324, 0.04140253]) #front
