...
save_file = '../tf_dataset_keypoints/front_allset/dict15k_tfrecords.pkl'
tfrec_dest = '../tf_dataset_keypoints/front_allset/'
    ...
    i_frame = {'filename': im_path + D[i]['frame_name'],
               ...
               'object': {
                   ...
                   'bbox': {
                       ...
                       'score':[1,1]},
                   'parts':{
                        'x':Bp[1][[0,3,6]].tolist() + Wp[1][[0,3,6]].tolist(),
                        'y':Bp[0][[0,3,6]].tolist() + Wp[0][[0,3,6]].tolist(),
                        'v':[2]*(3 + 3),
                        'count': [3,3]
                    }}}
