...
with open('/PATH_TO/AMT10K_csv.pkl','rb') as fp:
    D = pickle.load(fp)
print 'load'

im_path = '/PATH_TO_FRAMES_IMGS/'
...
#save the dict
if not os.path.exists('../tf_dataset_detection/top_separate_allset'):          os.makedirs('../tf_dataset_detection/top_separate_allset')
if not os.path.exists('../tf_dataset_detection/top_separate_allset/black'):    os.makedirs('../tf_dataset_detection/top_separate_allset/black')
if not os.path.exists('../tf_dataset_detection/top_separate_allset/white'):    os.makedirs('../tf_dataset_detection/top_separate_allset/white')
with open('../tf_dataset_detection/top_separate_allset/dict15k_tfrecords_black.pkl','wb') as fp:    pickle.dump(v_infob,fp)
with open('../tf_dataset_detection/top_separate_allset/dict15k_tfrecords_white.pkl','wb') as fp:    pickle.dump(v_infow,fp)
print ('done ')
...
tfrec_dest = '../tf_dataset_detection/top_separate_allset/black/'
# create tf records
...
# where to save the files
tfrec_dest = '../tf_dataset_detection/top_separate_allset/white/'
# create tf records
