...
And you've made it! Take a deep breath, then return to the [MARS Pose Annotation Tools ReadMe](https://github.com/neuroethology/MARS_Developer/tree/develop/pose_annotation_tools#mars-pose-annotation-tools-a-module-for-crowdsourcing-pose-estimation) and proceed to step 4 to clean up these annotations and visualize some example images!
