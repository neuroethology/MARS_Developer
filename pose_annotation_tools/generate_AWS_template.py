...
if __name__ ==  '__main__':
	...
	Arguments:
		config 		Path to project_config.yaml for your MARS annotation project
	"""

	parser = argparse.ArgumentParser(description='generate annotation interface html template from project_config.yaml', prog='generate_AWS_template')
	parser.add_argument('config', type=str, help="Path to project_config.yaml for your annotation project")
