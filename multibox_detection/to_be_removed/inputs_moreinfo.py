...
############ added filename and path to featues and return to output
...
def input_nodes(
  ...
  with tf.name_scope('inputs'):
    ...
    if shuffle_batch:
      images, batched_bboxes, batched_num_bboxes, image_ids, filenames,paths = tf.train.shuffle_batch(
        [image, bboxes, num_bboxes, image_id,filename,path],
      ...
      images, batched_bboxes, batched_num_bboxes, image_ids,filenames,paths = tf.train.batch(
        [image, bboxes, num_bboxes, image_id,filename,path],
        batch_size=batch_size,
        num_threads=num_threads,
        capacity= capacity, #batch_size * (num_threads + 2),
    ...
    return images, batched_bboxes, batched_num_bboxes, image_ids,filenames,paths
